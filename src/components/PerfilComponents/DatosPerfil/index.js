...
const DatosPerfil = ({ handlePerfilModal }) => {
    ...
    return (
        <PerfilContainer>
            ...
            {itsCurrentUserProfile ? <ImgPerfil src={datosUser.photoURL} /> : <ImgPerfil src={imgPerfil} />}

            {itsCurrentUserProfile ? (
                <EditarPerfil itsCurrentUserProfile={itsCurrentUserProfile} onClick={handlePerfilModal}>
                    Editar Perfil
